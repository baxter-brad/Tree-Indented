...
Note that in the indented text that is passed to this routine, the
newline character C<"\n"> is special: it always marks the end of a line
of text.
...
You may set C<$Tree::Indented::Char> to change the default.
...
You may set C<$Tree::Indented::Num> to change the default.
...
You may set C<$Tree::Indented::Strict> to change the default.
...
You may set C<$Tree::Indented::Char> and C<$Tree::Indented::Num> to
...
C<group> (a "group" is a parent plus its children), and to define
